...
public class MinecraftClientWrapper implements IMinecraftClientWrapper, IMinecraftSharedWrapper
{
	...
	@Override
	public String getUsername() { return MINECRAFT.player.getGameProfile().getName(); }
	...
	public ArrayList<ILevelWrapper> getAllServerWorlds()
	{
		...
		WorldServer[] serverWorlds = MINECRAFT.getIntegratedServer().worlds;
	...
	public void sendOverlayMessage(String string)
	{
		...
		Minecraft.getMinecraft().ingameGUI.setOverlayMessage(string, false);
	}
	...
	public void crashMinecraft(String errorMessage, Throwable exception)
	{
		...
		CrashReport report = CrashReport.makeCrashReport(exception, errorMessage);
	...
	@Override
	public File getInstallationDirectory() { return MINECRAFT.gameDir; }
	
	@Override
	public void executeOnRenderThread(Runnable runnable) { Minecraft.getMinecraft().addScheduledTask(runnable); }
